...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    //[self.navigationController presentModalViewController:registerView animated:YES];
   // self.presentingViewController = [registerView]
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[ProgressHUD show:@"Входим..." Interaction:NO];
...
{
	ParsePushUserAssign();
	[ProgressHUD showSuccess:[NSString stringWithFormat:@"С возвращением %@!", user[PF_USER_FULLNAME]]];
