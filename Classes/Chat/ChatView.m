...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[super viewDidLoad];
	self.title = @"Чат";
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logosnew"]];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (picture != nil)
	{
		...
		{
			if (error != nil) [ProgressHUD showError:@"Фотография не сохранена."];
		}];
	}
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	NSArray *menuItems = @[[[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_camera"] title:@"Камера"],
						   //[[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_audio"] title:@"Аудио"],
						   [[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_pictures"] title:@"Фотография"],
                           [[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_videos"] title:@"Видео"]];
						   //[[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_location"] title:@"Местоположение"],
						   //[[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_stickers"] title:@"Стикер"]];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ([item.title isEqualToString:@"Камера"])		PresentMultiCamera(self, YES);
//	if ([item.title isEqualToString:@"Аудио"])		ActionPremium(self);
	if ([item.title isEqualToString:@"Фотографию"])	PresentPhotoLibrary(self, YES);
	if ([item.title isEqualToString:@"Видео"])		PresentVideoLibrary(self, YES);
//	if ([item.title isEqualToString:@"Местоположение"])	ActionPremium(self);
//	if ([item.title isEqualToString:@"Стикеры"])	ActionPremium(self);
}
